...
$Form.Text = "Created by thirupathirajan_k@infosys.com" 
$Form.TopMost = $true 
$Form.Width = 900 
$Form.Height = 700 
...
$CERTbutton = New-Object system.windows.Forms.Button 
$CERTbutton.BackColor = "#5bd22c" 
$CERTbutton.Text = "Certificates" 
$CERTbutton.Width = 80 
$CERTbutton.Height = 22 
$CERTbutton.location = new-object system.drawing.point(600,51) 
$CERTbutton.Font = "Microsoft Sans Serif,8" 
$CERTbutton.FlatAppearance.MouseOverBackColor = [System.Drawing.Color]::FromArgb(255, 255, 36)
$CERTbutton.FlatStyle = [System.Windows.Forms.FlatStyle]::Flat
$CERTbutton.Cursor = [System.Windows.Forms.Cursors]::Hand
$CERTbutton.Add_Click({CERT}) 
$Form.controls.Add($CERTbutton) 

$GPRbutton = New-Object system.windows.Forms.Button 
$GPRbutton.BackColor = "#5bd22c" 
$GPRbutton.Text = "GPResults(slow)" 
$GPRbutton.Width = 100 
$GPRbutton.Height = 22 
$GPRbutton.location = new-object system.drawing.point(600,80) 
$GPRbutton.Font = "Microsoft Sans Serif,8" 
$GPRbutton.FlatAppearance.MouseOverBackColor = [System.Drawing.Color]::FromArgb(255, 255, 36)
$GPRbutton.FlatStyle = [System.Windows.Forms.FlatStyle]::Flat
$GPRbutton.Cursor = [System.Windows.Forms.Cursors]::Hand
$GPRbutton.Add_Click({GPR}) 
$Form.controls.Add($GPRbutton) 
...
foreach ($computer in $computers) 
{ 
$Script:formt.text="Working on $computer for Certificates expiring in 100 days" 
#$infcert +=Get-WmiObject -Class win32_service  -ComputerName $computer   -Filter "Name Like '%$sname%'" |  Select-Object PSComputerName,Name,StartMode,State 
$infcert +=Invoke-Command -ComputerName $computer -Command {
   get-childitem cert:LocalMachine\ -Recurse -Expiringindays 1000 |select Thumbprint,Subject,notafter

  #$infcert| Export-Csv -Path C:\Thiru\Auto\cert_results.csv -NoTypeInformation -Force
}
#$s = $infcert| ft -AutoSize | Out-String 
$s = $infcert| Format-List -Property Thumbprint,Subject,notafter | Out-String 
} 
$outputBox.Appendtext("{0}`n" -f $s+"`n $ct") 
$statusBar.Text=("Ready")
$Script:formt.close()  
...
foreach ($computer in $computers) 
{ 
$Script:formt.text="Working on $computer for GPResults" 
#$infcert +=Get-WmiObject -Class win32_service  -ComputerName $computer   -Filter "Name Like '%$sname%'" |  Select-Object PSComputerName,Name,StartMode,State 
#$infcert +=
#GPResult -ComputerName $computer -ReportType html -Path $pwdGPReport.htm
gpresult /S $computer /H C:\Thiru\Auto\$Computer.name.html
[void][System.Windows.Forms.MessageBox]::Show("Please check the output from C:/Thiru/Auto")
  #$infcert| Export-Csv -Path C:\Thiru\Auto\cert_results.csv -NoTypeInformation -Force
